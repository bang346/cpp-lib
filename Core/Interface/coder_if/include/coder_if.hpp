...
struct coder_if
{
    ...
    virtual coder_if_NS::len_t code(const std::uint8_t *data, const coder_if_NS::len_t &len, std::uint8_t *result) const = 0;
    ...
    /// @param result       Coded data
    /// @return             Len of the new data
    virtual coder_if_NS::len_t decode(const std::uint8_t *data, const coder_if_NS::len_t &len, std::uint8_t *result) = 0;
