...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "2.2.1"
  WORKING_DIRECTORY "C:/Users/marco/OneDrive/Dokumente/15.CPP_LIB/build/_deps/csv-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/marco/OneDrive/Dokumente/15.CPP_LIB/build/_deps/csv-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/marco/OneDrive/Dokumente/15.CPP_LIB/build/_deps/csv-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
